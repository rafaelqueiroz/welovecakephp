            ...
            <div class="row">
                <div class="col-md-6 onscroll-animate">
                    <?php 
                        ...
                        echo $this->Html->image("screen/php-rocks.jpg", array('class' => 'img-responsive'));
                    ?>
                </div>
                <div class="col-md-6 onscroll-animate" data-delay="400">
                    <article>
                        <div class="article-header-2">
                            <h1>Eu asso projetos todos os dias</h1>
                        </div>
                        <p>24, Brasileiro, Zend Certified Engineer, Especialista em CakePHP.</p>
                        <div class="margin-20"></div>
                        <p>Escrevi meu primeiro codigo ha 9 anos, ha 7 anos desenvolvo aplicacoes web com PHP, aproximadamente 4 anos me apaxoinei pelo CakePHP e desde entao tenho desenvolvido varios projetos usando, procurando sempre assar projetos melhores a cada dia. Eu crio e mantenho projetos todos os dias com CakePHP.</p>
                    </article>
                    <div class="margin-20"></div>
                    <div class="row">
                        <!--<div class="col-xs-6">
                            <div class="item-check">Zend Certified Engineer</div>
                            <div class="item-check">Standard CakePHP 3 Training</div>
                        </div>
                        <div class="col-xs-6">
                            <div class="item-check">CakePHP 2 Events</div>
                            <div class="item-check">Standard CakePHP 2 Training</div>
                        </div>-->
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="service-box">
                                ...
                                <p>Se você fosse meu cliente, os seus problemas seriam meus problemas agora.</p>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="service-box">
                                ...
                                <div class="horizontal-delimiter"></div>
                                <p>Desenvolvimento ágil de software, entre em contato, vou fazer-lhe uma proposta irrecusavel.</p>
                            </div>
                        </div>
                    </div><!-- .row -->
                </div><!-- .col-md-6 -->
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="service-box">
                                ...
                                <h2>Coaching</h2>
                                <div class="horizontal-delimiter"></div>
                                <p>Ajudo sua equipe aumentar a produtividade de forma efetiva e acelerada.</p>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="service-box">
                                ...
                                <h2>Treinamento</h2>
                                <div class="horizontal-delimiter"></div>
                                <p>Várias tecnicas que mais de 7 anos escrevendo para a web me ensinaram sobre o que funciona, e o que não.</p>
                            </div>
                        </div>
                    </div><!-- .row -->
                </div><!-- .col-md-6 -->
...
<div class="content-box">                    
        <div class="row">
            <div class="col-md-8 onscroll-animate fadeIn">
                <article>
                    <div class="article-header">
                        <h1>"Diga olá para o meu amiguinho"</h1>
                    </div>
                    <?php echo $this->Form->create(null, array('class' => "form-contact-alt"));?>
                    <form data-success-msg="Email successfully sent." data-ajax-fail-msg="Ajax could not set the request" data-all-fields-required-msg="All fields are required" method="post" action="send_email.php" id="contact-form-alt" class="form-contact-alt">
                        <div class="row">
                            <div class="col-sm-7">
            ...
            <div data-delay="500" class="col-md-4 onscroll-animate fadeIn">
                <article>
                    <div class="article-header">
                        <h1>Contact</h1>
                    </div>
                    <p>Say hello my little friend.</p>
                    <!--<div class="margin-20"></div>
